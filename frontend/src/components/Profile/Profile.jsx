  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${imageUrl})`,backgroundSize: 'cover', }}>
      ...
      <div className="flex flex-col items-center justify-center">
            ...
            />
            <label htmlFor="fileInput" className="rounded-circle flex flex-col items-center justify-center">
              <BiSolidImageAdd   className="rounded text-white transform scale-150" />
              <input
                type="file"
                id="fileInput"
                hidden
            ...
            {img && img ? <button className='bg-blue-500 text-white p-2 my-2 rounded' onClick={onImgUpdate}>Update</button> : null}
          </div>
        <div className="mb-4">
        ...
        <div className="text-center">
          {edit ? (
            ...
            <button className="bg-blue-500 text-white p-2 my-2 rounded" onClick={() => setEdit(true)}>
              Edit Profile
            </button>
          )}
        </div>
