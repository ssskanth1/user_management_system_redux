...
const Signup = () => {
  ...
  const validate = async () => {
    ...
    if (password !== confirmPassword || confirmPassword === '') {
      setPasswordError('Enter Confirm password properly');
      check = false;
    }
  ...
  const imageUrl = '../../../public/wallpaperflare.com_wallpaper.jpg'
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${imageUrl})`,backgroundSize: 'cover', }}>
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <form action="">
          ...
          <button type="button" onClick={validate} className="bg-blue-500 text-white p-2 rounded w-full">
            Sign up
          </button>
        </form>
      </div>
